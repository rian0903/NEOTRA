  ...
  return (
    <section id="work" className="py-20 md:py-28 border-b border-[#E2E8F0] bg-white">
      <div className="max-w-[1080px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2-Column Portfolio Grid with Staggered Scroll Animations */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {WORK_ITEMS.map((work, idx) => (
            <ScrollReveal key={work.slug} direction="up" delay={0.15 * (idx + 1)}>
              <div
                onClick={() => setSelectedWork(work)}
                className="card-agency-light rounded-2xl overflow-hidden cursor-pointer group flex flex-col h-full"
              >
